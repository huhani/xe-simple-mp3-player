(function(w){function x(a){return parseInt(a)===a}function z(a){if(!x(a.length))return!1;for(var b=0;b<a.length;b++)if(!x(a[b])||0>a[b]||255<a[b])return!1;return!0}function g(a,b){if(a.buffer&&ArrayBuffer.isView(a)&&"Uint8Array"===a.name)return b&&(a=a.slice?a.slice():Array.prototype.slice.call(a)),a;if(Array.isArray(a)){if(!z(a))throw Error("Array contains invalid value: "+a);return new Uint8Array(a)}if(x(a.length)&&z(a))return new Uint8Array(a);throw Error("unsupported array-like object");}function h(a){return new Uint8Array(a)}
function f(a,b,d,c,e){if(null!=c||null!=e)a=a.slice?a.slice(c,e):Array.prototype.slice.call(a,c,e);b.set(a,d)}function y(a){for(var b=[],d=0;d<a.length;d+=4)b.push(a[d]<<24|a[d+1]<<16|a[d+2]<<8|a[d+3]);return b}var n=function(){return{toBytes:function(a){var b=[],d=0;for(a=encodeURI(a);d<a.length;){var c=a.charCodeAt(d++);37===c?(b.push(parseInt(a.substr(d,2),16)),d+=2):b.push(c)}return g(b)},fromBytes:function(a){for(var b=[],d=0;d<a.length;){var c=a[d];128>c?(b.push(String.fromCharCode(c)),d++):
191<c&&224>c?(b.push(String.fromCharCode((c&31)<<6|a[d+1]&63)),d+=2):(b.push(String.fromCharCode((c&15)<<12|(a[d+1]&63)<<6|a[d+2]&63)),d+=3)}return b.join("")}}}(),A=function(){return{toBytes:function(a){for(var b=[],d=0;d<a.length;d+=2)b.push(parseInt(a.substr(d,2),16));return b},fromBytes:function(a){for(var b=[],d=0;d<a.length;d++){var c=a[d];b.push("0123456789abcdef"[(c&240)>>4]+"0123456789abcdef"[c&15])}return b.join("")}}}(),B={16:10,24:12,32:14},C=[1,2,4,8,16,32,64,128,27,54,108,216,171,77,
154,47,94,188,99,198,151,53,106,212,179,125,250,239,197,145],l=[99,124,119,123,242,107,111,197,48,1,103,43,254,215,171,118,202,130,201,125,250,89,71,240,173,212,162,175,156,164,114,192,183,253,147,38,54,63,247,204,52,165,229,241,113,216,49,21,4,199,35,195,24,150,5,154,7,18,128,226,235,39,178,117,9,131,44,26,27,110,90,160,82,59,214,179,41,227,47,132,83,209,0,237,32,252,177,91,106,203,190,57,74,76,88,207,208,239,170,251,67,77,51,133,69,249,2,127,80,60,159,168,81,163,64,143,146,157,56,245,188,182,218,
33,16,255,243,210,205,12,19,236,95,151,68,23,196,167,126,61,100,93,25,115,96,129,79,220,34,42,144,136,70,238,184,20,222,94,11,219,224,50,58,10,73,6,36,92,194,211,172,98,145,149,228,121,231,200,55,109,141,213,78,169,108,86,244,234,101,122,174,8,186,120,37,46,28,166,180,198,232,221,116,31,75,189,139,138,112,62,181,102,72,3,246,14,97,53,87,185,134,193,29,158,225,248,152,17,105,217,142,148,155,30,135,233,206,85,40,223,140,161,137,13,191,230,66,104,65,153,45,15,176,84,187,22],r=[82,9,106,213,48,54,165,
...
...
1011452712,893681702,1108339068,1258480242,1343618912,1494807662,1715193156,1865862730,1948373848,2100090966,2701949495,2818666809,3004591147,3122358053,2235061775,2352307457,2535604243,2653899549,3915653703,3764988233,4219352155,4067639125,3444575871,3294430577,3746175075,3594982253,836553431,953270745,600235211,718002117,367585007,484830689,133361907,251657213,2041877159,1891211689,1806599355,1654886325,1568718495,1418573201,1335535747,1184342925],k=function(a){if(!(this instanceof k))throw Error("AES must be instanitated with `new`");
Object.defineProperty(this,"key",{value:g(a,!0)});this._prepare()};k.prototype._prepare=function(){var a=B[this.key.length];if(null==a)throw Error("invalid key size (must be 16, 24 or 32 bytes)");this._Ke=[];this._Kd=[];for(var b=0;b<=a;b++)this._Ke.push([0,0,0,0]),this._Kd.push([0,0,0,0]);var d=4*(a+1),c=this.key.length/4,e=y(this.key);for(b=0;b<c;b++){var g=b>>2;this._Ke[g][b%4]=e[b];this._Kd[a-g][b%4]=e[b]}g=0;for(var h=c;h<d;){b=e[c-1];e[0]=e[0]^l[b>>16&255]<<24^l[b>>8&255]<<16^l[b&255]<<8^l[b>>
24&255]^C[g]<<24;g+=1;if(8!=c)b=1;else{for(b=1;b<c/2;b++)e[b]^=e[b-1];b=e[c/2-1];e[c/2]=e[c/2]^l[b&255]^l[b>>8&255]<<8^l[b>>16&255]<<16^l[b>>24&255]<<24;b=c/2+1}for(;b<c;b++)e[b]^=e[b-1];b=0;for(var f,k;b<c&&h<d;)f=h>>2,k=h%4,this._Ke[f][k]=e[b],this._Kd[a-f][k]=e[b++],h++}for(f=1;f<a;f++)for(k=0;4>k;k++)b=this._Kd[f][k],this._Kd[f][k]=L[b>>24&255]^M[b>>16&255]^N[b>>8&255]^O[b&255]};k.prototype.encrypt=function(a){if(16!=a.length)throw Error("invalid plaintext size (must be 16 bytes)");var b=this._Ke.length-
1,d=[0,0,0,0];a=y(a);for(var c=0;4>c;c++)a[c]^=this._Ke[0][c];for(var e=1;e<b;e++){for(c=0;4>c;c++)d[c]=D[a[c]>>24&255]^E[a[(c+1)%4]>>16&255]^F[a[(c+2)%4]>>8&255]^G[a[(c+3)%4]&255]^this._Ke[e][c];a=d.slice()}d=h(16);for(c=0;4>c;c++)e=this._Ke[b][c],d[4*c]=(l[a[c]>>24&255]^e>>24)&255,d[4*c+1]=(l[a[(c+1)%4]>>16&255]^e>>16)&255,d[4*c+2]=(l[a[(c+2)%4]>>8&255]^e>>8)&255,d[4*c+3]=(l[a[(c+3)%4]&255]^e)&255;return d};k.prototype.decrypt=function(a){if(16!=a.length)throw Error("invalid ciphertext size (must be 16 bytes)");
var b=this._Kd.length-1,d=[0,0,0,0];a=y(a);for(var c=0;4>c;c++)a[c]^=this._Kd[0][c];for(var e=1;e<b;e++){for(c=0;4>c;c++)d[c]=H[a[c]>>24&255]^I[a[(c+3)%4]>>16&255]^J[a[(c+2)%4]>>8&255]^K[a[(c+1)%4]&255]^this._Kd[e][c];a=d.slice()}d=h(16);for(c=0;4>c;c++)e=this._Kd[b][c],d[4*c]=(r[a[c]>>24&255]^e>>24)&255,d[4*c+1]=(r[a[(c+3)%4]>>16&255]^e>>16)&255,d[4*c+2]=(r[a[(c+2)%4]>>8&255]^e>>8)&255,d[4*c+3]=(r[a[(c+1)%4]&255]^e)&255;return d};var t=function(a){if(!(this instanceof t))throw Error("AES must be instanitated with `new`");
this.description="Electronic Code Block";this.name="ecb";this._aes=new k(a)};t.prototype.encrypt=function(a){a=g(a);if(0!==a.length%16)throw Error("invalid plaintext size (must be multiple of 16 bytes)");for(var b=h(a.length),d=h(16),c=0;c<a.length;c+=16)f(a,d,0,c,c+16),d=this._aes.encrypt(d),f(d,b,c);return b};t.prototype.decrypt=function(a){a=g(a);if(0!==a.length%16)throw Error("invalid ciphertext size (must be multiple of 16 bytes)");for(var b=h(a.length),d=h(16),c=0;c<a.length;c+=16)f(a,d,0,c,
c+16),d=this._aes.decrypt(d),f(d,b,c);return b};var u=function(a,b){if(!(this instanceof u))throw Error("AES must be instanitated with `new`");this.description="Cipher Block Chaining";this.name="cbc";if(!b)b=h(16);else if(16!=b.length)throw Error("invalid initialation vector size (must be 16 bytes)");this._lastCipherblock=g(b,!0);this._aes=new k(a)};u.prototype.encrypt=function(a){a=g(a);if(0!==a.length%16)throw Error("invalid plaintext size (must be multiple of 16 bytes)");for(var b=h(a.length),
d=h(16),c=0;c<a.length;c+=16){f(a,d,0,c,c+16);for(var e=0;16>e;e++)d[e]^=this._lastCipherblock[e];this._lastCipherblock=this._aes.encrypt(d);f(this._lastCipherblock,b,c)}return b};u.prototype.decrypt=function(a){a=g(a);if(0!==a.length%16)throw Error("invalid ciphertext size (must be multiple of 16 bytes)");for(var b=h(a.length),d=h(16),c=0;c<a.length;c+=16){f(a,d,0,c,c+16);d=this._aes.decrypt(d);for(var e=0;16>e;e++)b[c+e]=d[e]^this._lastCipherblock[e];f(a,this._lastCipherblock,0,c,c+16)}return b};
var v=function(a,b,d){if(!(this instanceof v))throw Error("AES must be instanitated with `new`");this.description="Cipher Feedback";this.name="cfb";if(!b)b=h(16);else if(16!=b.length)throw Error("invalid initialation vector size (must be 16 size)");d||(d=1);this.segmentSize=d;this._shiftRegister=g(b,!0);this._aes=new k(a)};v.prototype.encrypt=function(a){if(0!=a.length%this.segmentSize)throw Error("invalid plaintext size (must be segmentSize bytes)");a=g(a,!0);for(var b,d=0;d<a.length;d+=this.segmentSize){b=
this._aes.encrypt(this._shiftRegister);for(var c=0;c<this.segmentSize;c++)a[d+c]^=b[c];f(this._shiftRegister,this._shiftRegister,0,this.segmentSize);f(a,this._shiftRegister,16-this.segmentSize,d,d+this.segmentSize)}return a};v.prototype.decrypt=function(a){if(0!=a.length%this.segmentSize)throw Error("invalid ciphertext size (must be segmentSize bytes)");for(var b=g(a,!0),d,c=0;c<b.length;c+=this.segmentSize){d=this._aes.encrypt(this._shiftRegister);for(var e=0;e<this.segmentSize;e++)b[c+e]^=d[e];
f(this._shiftRegister,this._shiftRegister,0,this.segmentSize);f(a,this._shiftRegister,16-this.segmentSize,c,c+this.segmentSize)}return b};var p=function(a,b){if(!(this instanceof p))throw Error("AES must be instanitated with `new`");this.description="Output Feedback";this.name="ofb";if(!b)b=h(16);else if(16!=b.length)throw Error("invalid initialation vector size (must be 16 bytes)");this._lastPrecipher=g(b,!0);this._lastPrecipherIndex=16;this._aes=new k(a)};p.prototype.encrypt=function(a){a=g(a,!0);
for(var b=0;b<a.length;b++)16===this._lastPrecipherIndex&&(this._lastPrecipher=this._aes.encrypt(this._lastPrecipher),this._lastPrecipherIndex=0),a[b]^=this._lastPrecipher[this._lastPrecipherIndex++];return a};p.prototype.decrypt=p.prototype.encrypt;var m=function(a){if(!(this instanceof m))throw Error("Counter must be instanitated with `new`");0===a||a||(a=1);"number"===typeof a?(this._counter=h(16),this.setValue(a)):this.setBytes(a)};m.prototype.setValue=function(a){if("number"!==typeof a||parseInt(a)!=
a)throw Error("invalid counter value (must be an integer)");for(var b=15;0<=b;--b)this._counter[b]=a%256,a>>=8};m.prototype.setBytes=function(a){a=g(a,!0);if(16!=a.length)throw Error("invalid counter bytes size (must be 16 bytes)");this._counter=a};m.prototype.increment=function(){for(var a=15;0<=a;a--)if(255===this._counter[a])this._counter[a]=0;else{this._counter[a]++;break}};var q=function(a,b){if(!(this instanceof q))throw Error("AES must be instanitated with `new`");this.description="Counter";
this.name="ctr";b instanceof m||(b=new m(b));this._counter=b;this._remainingCounter=null;this._remainingCounterIndex=16;this._aes=new k(a)};q.prototype.encrypt=function(a){a=g(a,!0);for(var b=0;b<a.length;b++)16===this._remainingCounterIndex&&(this._remainingCounter=this._aes.encrypt(this._counter._counter),this._remainingCounterIndex=0,this._counter.increment()),a[b]^=this._remainingCounter[this._remainingCounterIndex++];return a};q.prototype.decrypt=q.prototype.encrypt;n={AES:k,Counter:m,ModeOfOperation:{ecb:t,
cbc:u,cfb:v,ofb:p,ctr:q},utils:{hex:A,utf8:n},padding:{pkcs7:{pad:function(a){a=g(a,!0);var b=16-a.length%16,d=h(a.length+b);f(a,d);for(a=a.length;a<d.length;a++)d[a]=b;return d},strip:function(a){a=g(a,!0);if(16>a.length)throw Error("PKCS#7 invalid length");var b=a[a.length-1];if(16<b)throw Error("PKCS#7 padding byte out of range");for(var d=a.length-b,c=0;c<b;c++)if(a[d+c]!==b)throw Error("PKCS#7 invalid padding byte");b=h(d);f(a,b,0,0,d);return b}}},_arrayTest:{coerceArray:g,createArray:h,copyArray:f}};
"undefined"!==typeof exports?module.exports=n:"function"===typeof define&&define.amd?define(n):(w.aesjs&&(n._aesjs=w.aesjs),w.aesjs=n)})(this);